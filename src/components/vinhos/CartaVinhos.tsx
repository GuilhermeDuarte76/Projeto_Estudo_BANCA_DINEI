        ...
        >
          <div className="inline-block p-1.5 border border-gold-light/30 rounded-[2rem] bg-bordeaux-deep/50">
            <div className="px-6 py-6 sm:px-10 sm:py-8 rounded-[calc(2rem-0.375rem)] flex flex-col items-center gap-5">
              ...
              <a
                href="https://wa.me/5534991633698?text=Ol%C3%A1!%20Vi%20a%20carta%20de%20vinhos%20no%20site%20da%20Banca%20do%20Dinei%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20r%C3%B3tulos%20dispon%C3%ADveis."
                target="_blank"
