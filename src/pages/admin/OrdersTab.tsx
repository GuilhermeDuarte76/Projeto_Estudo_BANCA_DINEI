  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
      ...
      <div>
        ...
        <h3 className="font-display font-bold text-xl text-cream mb-2">Pedidos</h3>
        <p className="type-body text-cream/40 text-sm max-w-xs">
          O endpoint de pedidos ainda não está disponível na API. Será implementado em breve.
        </p>
      </div>
    </div>
  )
